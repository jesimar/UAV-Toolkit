...
#Description: Script that tests the installed software.
#Descrição: Script que testa os softwares instalados.
...
echo "---------------Test Dronekit SITL--------------"
dronekit-sitl --version
python Test-Sw-Installed/dronekit-sitl-test.py
