...
public class UtilRoute {
    ...
    public static boolean readRoute(Mission wps, String path, int time) {
        try {
    ...
    public static boolean readFileRoute(Mission wps, String path, int nRoute, int size) {
        try {
            BufferedReader br = new BufferedReader(new FileReader(path));
            String sCurrentLine;
    ...
    public static boolean readFileRoute(Mission wps, String path){
        try {
            BufferedReader br = new BufferedReader(new FileReader(path));
            String sCurrentLine;
            boolean firstTime = true;
    ...
    public static void execRouteSimplifier(String nameRoute, String dirRouteSimplifier,
        ...
        try {
            ...
            String cmd = "python Route-Simplifier.py " + factor + 
                    " " + "../" + nameRoute + " '" + separator + "'";
            RunThread.dualSingleThread(cmd, new File(dirRouteSimplifier), print, print);
        } catch (IOException ex) {
