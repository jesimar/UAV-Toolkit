 ...
 */
public class ReaderMapFull {
    
    private final Map map;
    private final String path;

    public ReaderMapFull(Map map, String pathFile) {
        this.map = map;
        this.path = pathFile;
    }
    ...
    public void read(){
        ...
        try {
            ...
            while (sc.hasNext()) {
                ...
                sc.nextLine();
                int amountOfNFZ = Integer.parseInt(sc.nextLine());
                sc.nextLine();
                int amountOfPenalty = Integer.parseInt(sc.nextLine());
                sc.nextLine();
                int amountOfBonus = Integer.parseInt(sc.nextLine());
                for (int i = 0; i < amountOfNFZ; i++){
                    sc.nextLine();
                ...
                for (int i = 0; i < amountOfPenalty; i++){
                    sc.nextLine();
                    String valueX = sc.nextLine();
                    String valueY = sc.nextLine();
                    String vX[] = valueX.split(",");
                    ...
                    map.addPoly(new Poly2D(""+i, TypeRegion.PENALTY_REGION, points));
                }
                for (int i = 0; i < amountOfBonus; i++){
                    sc.nextLine();
                    String valueX = sc.nextLine();
                    String valueY = sc.nextLine();
                    String vX[] = valueX.split(",");
                    ...
                    map.addPoly(new Poly2D(""+i, TypeRegion.BONUS_REGION, points));
                }
            }
