...
/**
 * The class models the path planner Generic PathPlanner4m.
 * @author Jesimar S. Arantes
 * @since version 4.0.0
 * @see Planner
 */
public class PathPlanner4m extends Planner{
     ...
     * @since version 4.0.0
     */
    public PathPlanner4m(Drone drone, Mission3D waypointsMission) {
