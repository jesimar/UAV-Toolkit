...
/**
 * Classe que modela o replanejador de rotas MILP4s.
 * @author Jesimar S. Arantes
 */
public class MILP4s extends Replanner{
    
    /**
     * Class constructor
     * @param drone instance of the aircraft
     */
    public MILP4s(Drone drone) {
        super(drone);
    }
    ...
    public boolean updateFileConfig() { 
        try {
            ...
            File src_ms = new File(dir + "instance-base");
            File dst_ms = new File(dir + "instance");
