...
public class DE4s extends Replanner{
    ...
    public boolean updateFileConfig() { 
        try {
            ...
            double vel = 5;//drone.getSensorUAV().groundspeed;
            double dt = 2; //melhorar
            double proj_px = px;//px + vx * dt;
            double proj_py = py;//py + vy * dt;
            System.out.println("px = " + px);
            System.out.println("py = " + py);
            System.out.println("lat = " + drone.getGPS().lat);
            System.out.println("lng = " + drone.getGPS().lng);
            System.out.println("vx = " + vx);
            System.out.println("vy = " + vy);
            System.out.println("angle = " + angle);
            System.out.println("vel = " + vel);
            System.out.println("dt = " + dt);
            System.out.println("proj_px = " + proj_px);
            System.out.println("proj_py = " + proj_py);
            px = proj_px;
            py = proj_py;
            ...
            UtilIO.copyFileMofifIfa(src, dst, state, 8, maxVel, 10, maxCtrl, 18, qtdWpt, 20, delta, 26);
